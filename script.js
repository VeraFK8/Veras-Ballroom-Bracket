...
function loadDynamicTestRecap() {
  ...
  const lines = [
    ...
    `${label(cast[1])} earned 22 points and were safe.`,
    `${label(cast[2])} received 20 points and landed in the bottom group.`,
    `${label(cast[3])} scored 18 points and were eliminated from the competition.`,
    `${label(cast[4])} earned a perfect score of 40 points and were safe.`,
    `${label(cast[5])} received the first 10 of the season and scored 28 points.`,
    `${label(cast[6])} won the dance-off challenge and scored 26 points.`
  ];
